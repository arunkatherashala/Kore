...
**Version 1.6.27** | [RubyGems](https://rubygems.org/gems/kore-fileformat) | [GitHub](https://github.com/arunkatherashala/Kore)
...
```bash
gem install kore-fileformat -v 1.6.27
```
...
gem install kore-fileformat-1.6.27.gem
```
