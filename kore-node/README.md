...
**Version 1.6.30** | [npm](https://www.npmjs.com/package/kore-fileformat) | [GitHub](https://github.com/arunkatherashala/Kore)
...
Every `.kore` file has a human-readable header:
