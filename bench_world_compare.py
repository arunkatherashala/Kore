...
features = [
    ...
    ('Zero-copy read (mmap)',              'N Y N N N N N N   N  Y  Y  N  N  N  Y  N  Y  N'),
    ...
    ('Streaming write (large files)',       'N N Y Y Y N N N   Y  Y  Y  Y  Y  Y  Y  N  Y  N'),
    ('Predicate pushdown (skip rows)',      'N N N N N N N N   Y  Y  N  N  N  N  N  N  N  N'),
