...
**Version 1.7.30** | [Packagist](https://packagist.org/packages/arunkatherashala/kore-fileformat) | [GitHub](https://github.com/arunkatherashala/Kore)
...
```bash
composer require arunkatherashala/kore-fileformat:1.7.30
```
