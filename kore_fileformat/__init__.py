...
try:
    ...
    KoreML      = _core.PyKoreML
    KoreVault   = _core.PyKoreVault
    KorePress   = _core.PyKorePress
    KoreParallel= _core.PyKoreParallel
    KoreGraph   = _core.PyKoreGraph
    KoreServe   = _core.PyKoreServe
    KoreConnect = _core.PyKoreConnect
