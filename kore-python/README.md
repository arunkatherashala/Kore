...
**Version 1.6.30** | [PyPI](https://pypi.org/project/kore-fileformat/) | [GitHub](https://github.com/arunkatherashala/Kore)
...
| `read_file(path)` | Read .kore → DataBlock (returns array.array, no tolist) |
| `write_hybrid(path, block)` | Write .hkore (raw binary + header, 28 ns/row read) |
