...
**Version 1.7.17** | [NuGet](https://www.nuget.org/packages/KoreFileFormat/) | [GitHub](https://github.com/arunkatherashala/Kore)
...
```bash
dotnet add package KoreFileFormat --version 1.7.17
```
